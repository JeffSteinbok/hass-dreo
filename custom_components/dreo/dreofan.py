...
class DreoFanHA(DreoBaseDeviceHA, FanEntity):
    ...
    def supported_features(self) -> int:
        ...
        if hasattr(self.device, "preset_modes") and self.device.preset_modes is not None:
            supported_features = supported_features | FanEntityFeature.PRESET_MODE
        if hasattr(self.device, "oscillating") and self.device.oscillating is not None:
