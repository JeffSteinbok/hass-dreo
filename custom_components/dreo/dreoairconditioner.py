...
class DreoAirConditionerHA(DreoBaseDeviceHA, ClimateEntity):
    ...
    def __init__(self, pyDreoDevice: PyDreoAC) -> None:
        ...
        self._attr_hvac_mode = (
            AC_MODE_MAP[self.device.mode] if self.device.poweron else HVACMode.OFF
        )
    ...
    def fan_mode(self) -> str:
        ...
        _LOGGER.debug(
            "DreoAirConditionerHA:fan_mode(%s): %s",
            self.device.name,
    ...
    def set_fan_mode(self, fan_mode: str) -> None:
        ...
        _LOGGER.debug(
            "DreoAirConditionerHA:set_fan_mode(%s) --> %s", self.device.name, fan_mode
        )
    ...
    def preset_modes(self) -> list[str]:
        ...
        _LOGGER.debug(
            "DreoAirConditionerHA:preset_mode(%s): %s",
            self.device.name,
            self.device.preset_mode,
        )
    ...
    def set_preset_mode(self, preset_mode: str) -> None:
        ...
        _LOGGER.debug(
            "DreoAirConditionerHA:set_preset_mode(%s) --> %s",
            self.device.name,
            preset_mode,
        )
    ...
    def supported_features(self) -> int:
        ...
        if (
            self.device.target_temperature is not None
            and self.device.mode == DREO_AC_MODE_COOL
        ):
            supported_features |= ClimateEntityFeature.TARGET_TEMPERATURE
        if (
            self.device.preset_mode is not None
            or self.device.device_definition.preset_modes is not None
        ) and self.device.mode == DREO_AC_MODE_COOL:
            supported_features |= ClimateEntityFeature.PRESET_MODE
        if self.device.oscon is not None:
            supported_features |= ClimateEntityFeature.SWING_MODE
        if (
            self.device.fan_mode is not None
            or self.device.device_definition.fan_modes is not None
        ):
        ...
        if (
            self.device.target_humidity is not None
            and self.device.mode == DREO_AC_MODE_DRY
        ):
            supported_features |= ClimateEntityFeature.TARGET_HUMIDITY

        _LOGGER.debug(
            "DreoAirConditionerHA:supported_features(%s): %s (device.mode: %s)",
            self,
            supported_features,
            self.device.mode,
        )
    ...
    def oscangle(self, oscangle: str) -> None:
        ...
        _LOGGER.debug(
            "DreoAirConditionerHA::oscangle(%s) -> %s", self.device.name, oscangle
        )
    ...
    def panel_sound(self, panel_sound: bool) -> None:
        ...
        _LOGGER.debug(
            "DreoAirConditionerHA::panel_sound(%s) --> %s",
            self.device.name,
            panel_sound,
        )
    ...
    def muteon(self, muteon: bool) -> None:
        ...
        _LOGGER.debug(
            "DreoAirConditionerHA::muteon(%s) --> %s", self.device.name, muteon
        )
    ...
    def set_temperature(self, **kwargs: Any) -> None:
        ...
        _LOGGER.debug(
            "DreoAirConditionerHA::set_temperature(%s) %s --> %s",
            self.device.name,
            self._attr_target_temperature,
    ...
    def set_humidity(self, humidity: int) -> None:
        ...
        _LOGGER.debug(
            "DreoAirConditionerHA::set_humidity(%s) %s --> %s",
            self.device.name,
    ...
    def hvac_mode(self):
        ...
        _LOGGER.debug(
            "DreoAirConditionerHA:hvac_mode(%s): %s (device.mode: %s)",
            self.device.name,
            self._attr_hvac_mode,
            self.device.mode,
        )
    ...
    def set_hvac_mode(self, hvac_mode: HVACMode) -> None:
        ...
        _LOGGER.debug(
            "DreoAirConditionerHA:set_hvac_mode(%s) %s --> %s",
            self.device.name,
    ...
    def set_swing_mode(self, swing_mode: str) -> None:
        ...
        _LOGGER.debug(
            "DreoAirConditionerHA:set_swing_mode(%s) -> %s",
            self.device.name,
            swing_mode,
        )
