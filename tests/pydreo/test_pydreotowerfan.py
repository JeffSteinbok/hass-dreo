...
class TestPyDreoTowerFan(TestBase):
    ...
    def test_HTF018S(self):  # pylint: disable=invalid-name
        """Load HTF018S tower fan and test sending commands."""
    ...
    def test_HTF017S(self):  # pylint: disable=invalid-name
        """Load HTF017S tower fan and test sending commands."""
    ...
    def test_HTF011S(self):  # pylint: disable=invalid-name
        ...
        self.get_devices_file_name = "get_devices_HTF011S.json"
        self.pydreo_manager.load_devices()
        assert len(self.pydreo_manager.devices) == 1
        fan = self.pydreo_manager.devices[0]
    ...
    def test_HTF518S(self):  # pylint: disable=invalid-name
        ...
        self.get_devices_file_name = "get_devices_HTF518S.json"
        self.pydreo_manager.load_devices()
        assert len(self.pydreo_manager.devices) == 1
        fan = self.pydreo_manager.devices[0]
