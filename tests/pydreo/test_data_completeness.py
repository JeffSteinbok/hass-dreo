        ...
        for state_file in state_files:
            ...
            if not expected_devices_file.exists():
                orphaned_state_files.append(
                    {"state_file": state_file.name, "expected_devices_file": expected_devices_file.name, "model": model_from_filename}
                )
            ...
            if device_id:
                ...
                if not device_id.isdigit():
                    invalid_device_ids.append(
                        {"file": device_file.name, "device_id": device_id, "reason": "deviceId must be a string containing only digits"}
                    )
